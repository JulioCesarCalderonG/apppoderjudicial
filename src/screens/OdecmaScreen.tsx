...
interface Props
  extends DrawerScreenProps<RootDrawerTransparenciaParams, 'Odecma'> {}

const OdecmaScreen = ({navigation}: Props) => {
  useEffect(() => {
      ...
      <ScrollView
        ...
        <TouchableOpacity
          ...
          <View style={style.viewIcono}>
            <Image
              source={require('../assets/img/icono-transparencia/iconos/quejas.png')}
              style={style.imgIcon}
            />
          </View>
        ...
        <TouchableOpacity
          ...
          <View style={style.viewIcono}>
            <Image
              source={require('../assets/img/icono-transparencia/iconos/mp.png')}
              style={style.imgIcon}
            />
          </View>
          <View style={style.viewText}>
